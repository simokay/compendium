...
You can issue any command you choose, short of an activity that would result in certain death. Should you issue a suicidal command, the spell ends. You can end the spell early by using an action to dismiss it. A <a href="{{ '/spells/Remove Curse' | url }}">Remove Curse</a>, [[Greater Restoration]], or [[Wish]] spell also ends it.
