...
A <a href="{{ '/spells/Remove Curse' | url }}">Remove Curse</a> or <a href="{{ '/spells/Greater Restoration' | url }}">Greater Restoration</a> spell cast on the target restores the creature’s true memory.
