...
A creature that can see the sensor (such as one using <a href="{{ '/spells/See Invisibility' | url }}">See Invisibility</a> or truesight) sees a translucent image of the tormented humanoid whose soul you caged.